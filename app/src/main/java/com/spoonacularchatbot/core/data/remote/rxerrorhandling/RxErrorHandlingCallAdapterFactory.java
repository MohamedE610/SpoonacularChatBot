package com.spoonacularchatbot.core.data.remote.rxerrorhandling;
...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
    ...
    private static class RxCallAdapterWrapper<R> implements CallAdapter<R, Object> {
        ...
        private SpoonacularException asRetrofitException(final Throwable throwable) {
        ...
        private SpoonacularException getServerDownException(Throwable throwable) {
            return new SpoonacularException(SpoonacularException.Kind.SERVER_DOWN, throwable.getMessage(), throwable);
        }

        private SpoonacularException getTimeoutException(Throwable throwable) {
            return new SpoonacularException(SpoonacularException.Kind.TIME_OUT, throwable.getMessage(), throwable);
        }
